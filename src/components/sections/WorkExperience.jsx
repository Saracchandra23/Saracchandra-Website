                            ...
                            <div className="flex space-x-8">
                                ...
                                <div className="text-gray-300">
                                    <div className="flex items-center space-x-2">
                                        {/* Logo */}
                                        <img
                                            src="/Saracchandra-Website/src/assets/amex.jpg"  // Adjust the path to where your logo is located
                            ...
                            <div className="flex space-x-8">
                                ...
                                <div className="text-gray-300">
                                    <div className="flex items-center space-x-2">
                                        {/* Logo */}
                                        <img
                                            src="/Saracchandra-Website/src/assets/Deloitte.jpg"  // Adjust the path to where your logo is located
                                            alt="Deloitte Logo"
                                            className="w-8 h-8"  // Adjust the size as needed
                                        />
                                        {/* Text */}
                            ...
                            <div className="flex space-x-8">
                                ...
                                <div className="text-gray-300">
                                    <div className="flex items-center space-x-2">
                                        {/* Logo */}
                                        <img
                                            src="/Saracchandra-Website/src/assets/HV.jpg"  // Adjust the path to where your logo is located
                            ...
                            <div className="flex space-x-8">
                                ...
                                <div className="text-gray-300">
                                    <div className="flex items-center space-x-2">
                                        {/* Logo */}
                                        <img
                                            src="/Saracchandra-Website/src/assets/FM.jpg"  // Adjust the path to where your logo is located
